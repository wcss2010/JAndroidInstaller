...
public class USBDeviceInfo {
    ...
    public static String[] androidDeviceConfigBuffer = null;
    ...
    public static String[] getAndroidDeviceConfig() throws Exception {
        if (androidDeviceConfigBuffer == null) {
            ...
            androidDeviceConfigBuffer = JAppToolKit.JDataHelper.readAllLines(aconfig.getAbsolutePath());
            return androidDeviceConfigBuffer;
        } else {
            return androidDeviceConfigBuffer;
        }
    }
